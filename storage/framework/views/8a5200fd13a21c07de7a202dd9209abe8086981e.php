...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="block-header">
            <a href="<?php echo URL::to('module/calling_queue/follow_ups'); ?>"><strong>Follow ups</strong></a>
        ...
        <div class="row clearfix" id="app">
            <div class="col-xs-7">
                <div class="card">
                    ...
                    <div class="body table-responsive">
                        <?php echo Form::open(['url'=>'module/calling_queue/search_follow_up']); ?>
                        ...
                        <div class="row">
                            <div class="col-xs-3">
                                <div class="input-group">
                                    ...
                                    <div class="form-line">
                                        <?php echo Form::text('from',request()->from ? request()->from : \Carbon\Carbon::now()->toDateString(),['placeholder'=>'From..', 'class'=>'form-control datepicker']); ?>
                            ...
                            <div class="col-xs-3">
                                <div class="input-group">
                                    ...
                                    <div class="form-line">
                                        <?php echo Form::text('to',request()->to ? request()->to: \Carbon\Carbon::now()->toDateString(),['placeholder'=>'To..', 'class'=>'form-control datepicker']); ?>
                            ...
                            <div class="col-xs-3">
                                <div class="input-group">
                                    <div class="form-line">
                                        <?php echo Form::select('status',['Switch Off'=>'Switch Off','No Answer'=>'No Answer','Interested'=>'Interested'],request()->status?request()->status:null,['placeholder'=>'--Status--', 'class'=>'selectpicker','data-width'=>'fit']); ?>
                            ...
                            <div class="col-xs-3">
                                <div class="input-group">
                                    <div class="form-line">
                                        <?php echo Form::submit('SEARCh',['class'=>'btn btn-md btn-block btn-success',]); ?>
            ...
            <div class="col-xs-5">
                <div class="card">
                    ...
                    <div class="body table-responsive" >
                        <?php echo Form::open(['url'=>url('module/calling_queue/create_from_follow_up_queue')]); ?>
...
<?php $__env->startSection('custom_page_script'); ?>
    ...
    <script type="text/javascript">
        ...
        let app = new Vue({
            ...
            data:{
                active_leads:<?php echo $follow_ups; ?>,
                selected_lead:{
                    follow_up_id:null,
                    queue_id:null,
                    status:null,
