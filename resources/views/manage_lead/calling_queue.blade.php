...
@section('content')
    <div class="container-fluid">
        <div class="block-header">
            <a href="{!! URL::to('module/lead') !!}"><strong>Lead bucket</strong></a>
        ...
        <div class="row clearfix" id="app">
            <div class="col-xs-7">
                <div class="card">
                    ...
                    <div class="body table-responsive">
                        ...
                        <p>ACTIVE LEADS: {!! $active_leads->count(); !!}</p>
            ...
            <div class="col-xs-5">
                <div class="card">
                    ...
                    <div class="body table-responsive" >
                        {!! Form::open(['url'=>url('module/calling_queue'),'ref'=>'form','@submit.prevent'=>'onSubmit']) !!}
